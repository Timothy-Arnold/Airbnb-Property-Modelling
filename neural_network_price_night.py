...
def save_model(model, hyper_dict, performance_metrics, nn_folder="models/regression/neural_networks_price_night"):
...
def find_best_nn(epochs=10):
    ...
    save_model(best_model, best_hyper_dict, best_metrics_dict, "models/regression/neural_networks_price_night/best_neural_networks")
